...
public class Ex03_primitive_type {
	...
	public static void main(String[] args) {
		...
		//항상 소수 자리수는 부정확할 수 있다.(BigDecima클래스를 이용해서 정확히 표현할수있다.)
		...
		long b=12345678900L;
		char c='a';
		float f=1.5F; //1.5F 에프를 붙이면 이것에 플롯을 저장할 숫자 이다.
		double d=1.5;
		boolean e = true;
		
		//primitive type은 변수에 데이터가 그대로 저장됩니다.
		System.out.println(); //컨트롤+알트+방향키하면 아래로 출력결과 복사돼어서 붙여진다.
		System.out.println();
		System.out.println();
		System.out.println();
		System.out.println();
